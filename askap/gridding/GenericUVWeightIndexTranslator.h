...
#ifndef ASKAP_SYNTHESIS_GRIDDING_GENERIC_UV_WEIGHT_INDEX_TRANSLATOR_H
#define ASKAP_SYNTHESIS_GRIDDING_GENERIC_UV_WEIGHT_INDEX_TRANSLATOR_H
...
/// interface.
/// @ingroup gridding
struct GenericUVWeightIndexTranslator : virtual public IUVWeightIndexTranslator { 
   ...
   explicit GenericUVWeightIndexTranslator(casacore::uInt coeffBeam = 0, casacore::uInt coeffField = 0, 
                                           casacore::uInt coeffSource = 0);
...
#endif // #ifndef ASKAP_SYNTHESIS_GRIDDING_GENERIC_UV_WEIGHT_INDEX_TRANSLATOR_H
